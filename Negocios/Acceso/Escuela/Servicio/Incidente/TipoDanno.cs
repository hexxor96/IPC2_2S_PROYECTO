...
namespace Negocios.Acceso.Escuela.Servicio.Incidente
{
	class TipoDanno
	{
		...
		/// </summary>
		/// <param name="nombre">Nombre del tipo de daño</param>
		/// <returns></returns>
		public int Crear(String nombre)
		{
			...
			String insert = "INSERT INTO TIPO_DANNO VALUES (@NOMBRE)";
			try
			{
		...
		public DataTable ObtenerGeneral()
		{
			...
			String query = "SELECT * FROM TIPO_DANNO";
		...
		/// <summary>
		/// Actualiza el nombre del tipo de daño
		/// </summary>
		...
		public int Actualizar(int identificador, String nuevoNombre)
		{
			...
			SqlConnection con = null;
			SqlCommand command = null;
			String insert = "UPDATE TIPO_DANNO SET NOMBRE = @NOMBRE WHERE IDTIPO_DANNO = @ID";
			try
			{
				using (con = new Conexion().Conectar())
				{
		...
		public int Eliminar(int identificador)
		{
			...
			SqlConnection con = null;
			SqlCommand command = null;
			String delete = "DELETE TIPO_DANNO WHERE IDTIPO_DANNO = @ID";
			try
			{
				using (con = new Conexion().Conectar())
				{
