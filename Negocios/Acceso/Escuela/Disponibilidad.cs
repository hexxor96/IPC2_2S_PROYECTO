...
namespace Negocios.Acceso.Escuela
{
	class Disponibilidad
	{
		...
		/// </summary>
		/// <param name="nombre">Nombre del disponibilidad</param>
		/// <returns></returns>
		public int Crear(String nombre)
		{
			...
			String insert = "INSERT INTO DISPONIBILIDAD VALUES (@NOMBRE)";
			try
			{
		...
		/// <summary>
		/// Actualiza el nombre del disponibilidad
		/// </summary>
		...
		public int Actualizar(int identificador, String nuevoNombre)
		{
			...
			SqlConnection con = null;
			SqlCommand command = null;
			String insert = "UPDATE DISPONIBILIDAD SET NOMBRE = @NOMBRE WHERE IDDISPONIBILIDAD = @ID";
			try
			{
				using (con = new Conexion().Conectar())
				{
		...
		public int Eliminar(int identificador)
		{
			...
			SqlConnection con = null;
			SqlCommand command = null;
			String delete = "DELETE DISPONIBILIDAD WHERE IDDISPONIBILIDAD = @ID";
			try
			{
				using (con = new Conexion().Conectar())
				{
